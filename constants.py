...
CARD_POOL = [
    ...
    {"name": "신데렐라는 아쉬워 벌써 12시", "type": "함정", "desc": "카드 수가 12개가 되면 즉시 승리"},
    {"name": "중간고사", "type": "즉발", "desc": "카드를 3장 버립니다"},
    {"name": "밥 먹을 시간이다", "type": "행동", "desc": "현재 카드 수의 2배를 추가 획득"},
    {"name": "하투하투", "type": "행동", "desc": "두장을 얻습니다"},
    {"name": "빛 빚 빗", "type": "행동", "desc": "50% 확률로 4장 획득 혹은 3장 상실"},
    ...
    {"name": "윤규는 슛돌이", "type": "행동", "desc": "윤규의 실수로 카드 5장을 버립니다"},
    ...
    {"name": "９와 ４분의３ 승강장", "type": "함정", "desc": "카드가 9장이 되면 3장 버리고 4장 뽑는다"},
